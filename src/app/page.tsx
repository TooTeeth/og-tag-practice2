...
export const metadata: Metadata = {
  ...
  description: "This page demonstrates how to up OpenGraph and Twitter Card meta tags using the Head component in NextJS.",
  openGraph: {
    title: "꽃",
    description: "꽃",
    type: "website",
...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-8 bg-gray-50">
      ...
      <p className="mt-4 text-sm text-gray-500">참고: 메타 태그는 페이지가 배포된s 후에 적용됩니다. 페이지를 배포한 후, Facebook Sharing Debugger나 Twitter Card Validator와 같은 도구로 미리보기를 확인하세요.</p>
      <div className="mt-8">
